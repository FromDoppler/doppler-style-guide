...
export const lineChart = function () {
  const chart = bb.generate({
    bindto: "#lineChart",
    data: {
      x: "x", // Specifies the x-axis categories (dates)
      columns: [
        [
          "x",
          "05-02-2025",
        ...
        ["Pop-up Promocional", 35, 5, 35, 10, 7], // Data for "Pop-up Promocional"
        ["Pop-up Suscripción", 0, 0, 5, 8, 4], // Data for "Pop-up Suscripción"
        ["Pop-up Productos populares", 28, 10, 28, 6, 5], // Data for "Pop-up Productos populares"
      ],
      type: line(),
    },
    padding: {
