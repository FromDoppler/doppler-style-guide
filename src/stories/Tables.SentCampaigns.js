...
export const Tables = ({ type }) => {
  return type == "Campaigns"
    ? html`<table class="dp-c-table dp-table-sent-campaigns">
        <caption></caption>
        <thead>
          <tr>
            <th class="long-column">
              <p>CAMPAÑAS</p>
            </th>
            <th>
          ...
          <tr>
            <td>
              <div class="dp-rowflex">
                ...
                <div class="col-sm-11">
                  ...
                  <p><strong>Remitente: </strong>fgonzalez@fromdoppler.com</p>
            ...
            <td>
              <div class="dp-icons-group m-t-30">
                <a href=""
                  ><span class="dpicon icon iconapp-infographic-chart"></span
                ></a>
                <a href=""
                  ><span class="dpicon icon iconapp-copy-file"></span
                ></a>
                <a href=""
                  ><span class="dpicon icon iconapp-trash-bin"></span
                ></a>
              </div>
            </td>
          </tr>
            ...
            <td colspan="12">
              <nav class="dp-pagination">
                <ul>
                  ...
                  <li><a href="#">14</a></li>
                  <li>
                    <span class="dp-active-page" aria-current="page">15</span>
                  </li>
                  <li><a href="#">16</a></li>
                  <li><a href="#">17</a></li>
                  <li>
